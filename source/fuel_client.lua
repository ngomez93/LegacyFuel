...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			if displayHud then
				DrawAdvancedText(0.1410 - x, 0.7765 - y, 0.005, 0.0028, 0.4, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.124 - x, 0.7765 - y, 0.005, 0.0028, 0.4, "Fuel", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
